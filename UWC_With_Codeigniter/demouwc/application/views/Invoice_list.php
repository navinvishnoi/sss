                                        ...
                                        <tbody>
                                            <tr class="gradeA">
                                               ...
                                               <td> <div class="checkbox"><input type="checkbox"></div></td>
                                                ...
                                                <td>Draft</td>
                                                <td><a href="<?php echo base_url()."user/View_Invoice"; ?>"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                    <a href="<?php echo base_url()."user/Add_Invoice"; ?>?edit"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" title="Edit"><i class='fa fa-edit'></i></button></a>
