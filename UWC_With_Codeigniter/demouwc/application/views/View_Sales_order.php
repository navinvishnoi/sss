...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | View Sales Order</title>
                ...
                <section class="content-header">
                    <h1>&nbsp;View Sales Order</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()."user/Sales_order_list"; ?>"><i class="fa fa-star"></i>Sales Order List</a></li>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                           <label class="col-xs-6">Sales Representative</label>
                                            Navin Vishnoi
                                        </div><!-- /.input group -->
                                        </div>
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                           <label class="col-xs-6">Sales Order ID</label>
                                            SO2211
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="col-xs-6">Sales Order</label>
                                            ABCD
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="col-xs-6">Customer Order</label>
                                            PQRST
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-md-12">
                                        ...
                                        <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="col-xs-6">Production Owner</label>
                                            Rohit Sisodiya
                                        </div><!-- /.input group -->
                                        </div>
                                    </div>
                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                       <!-- select -->
                                        <div class="form-group">
                                        <a href="<?php echo base_url()."user/Add_Invoice"; ?>?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Genrate Invoice"><i class="fa fa-plus"></i>&nbsp; Genrate Invoice</button></a>
                                        <a href="<?php echo base_url()."user/Add_Delivery_challan"; ?>?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Genrate Delivery challan"><i class="fa fa-plus"></i>&nbsp; Genrate Delivery challan</button></a>
                                         <a href="<?php echo base_url()."user/Order_Tracking"; ?>?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Order Tracking"><i class="fa fa-map-marker"></i>&nbsp; Order Tracking</button></a>
