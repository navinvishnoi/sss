...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | Order Receipt Screen</title>
                ...
                <section class="content">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option>Purchase Order No. 1</option>
                                            <option>Purchase Order No. 2</option>
                                            <option>Purchase Order No. 3</option>
                                            <option>Purchase Order No. 4</option>
                                            <option>Purchase Order No. 5</option>
                                            </select>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-4">
                                        <div class="form-group">
                                            ...
                                            <option>Vendor Name 4</option>
                                            <option>Vendor Name 5</option>
                                            </select>
                                        </div><!-- /.input group -->
                                        </div>
                        ...
                        <div class="box box-success">
                              ...
                              <tr>
                                ...
                                <th scope="col">Quantity Rreceived</th>
                              ...
                              <tr>
                                ...
                                <td><input type="text" class="form-control" placeholder="Enter Quantity Rreceived..."></td>
