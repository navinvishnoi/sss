                ...
                <section class="content-header">
                    <h1><?php echo $Edit; ?> Vendor</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()."user/Vendor_list"; ?>"><i class="fa fa-star"></i>Vendor List</a></li>
                ...
                <div class="col-md-12">
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="<?php echo base_url()."user/User_list"; ?>"><button type="submit" class="btn btn-success">Submit</button></a>
