                ...
                <section class="content-header">
                    <h1><?php echo $Edit; ?> Delivery Challan</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()."user/Delivery_challan_list"; ?>"><i class="fa fa-star"></i> New Delivery Challan List</a></li>
                ...
                <div class="box box-success">
                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="<?php echo base_url()."user/View_Delivery_challan"; ?>"><input type="button" class="btn btn-success" value="Submit" /></a>
...
function myFunction() {
	...
	cell7.innerHTML = "<a href='<?php echo base_url()."user/View_Inventory"; ?>'><button type='button' class='btn btn-success' data-toggle='tooltip' title='View Item Detail'><i class='fa  fa-eye'></i></button></a> <button type='button' class='btn btn-danger' onclick='deleteRow(this);' data-toggle='tooltip' title='Delete'><i class='fa  fa-times'></i></button>";
