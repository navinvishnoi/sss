...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | Add New Customer</title>
                    ...
                    <div class="tab-content">
                                    ...
                                    <div class="row">
                                       ...
                                       <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <option value="">Choose Head Office Address</option>
                                            <option class="Address1">Address 1</option>
                                            <option class="Address2">Address 2</option>
                                            <option class="Address3">Address 3</option>
                                            <option class="Address4">Address 4</option>
                                            <option class="Address5">Address 5</option>
                                            <option class="Address6">Address 6</option>
                                            <option class="Address7">Address 7</option>
                                            </select>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="School" placeholder="Enter Customer Class..." readonly/>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label>Customer Credit Limit</label>
                                            <input type="text" class="form-control" value="200000" placeholder="Enter Credit Limit..." readonly/>
                                        </div><!-- /.input group -->
                                        </div>
                                    </div>
                                    </div>
                        ...
                        <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title col-md-6">&nbsp;Address</h3><div class="box-title pull-right">
                                <button type="button" onclick="myFunction()" class="btn btn-success"  data-toggle="tooltip" title="Add More Address"><i class="fa fa-plus"></i>&nbsp;Add More Address</button>
                                </div>
                                </div>
                                <div class="box-body">
                                    <div class="row">
               ...
               <div class="col-md-12">
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="<?php echo base_url()."user/Customer_list"; ?>"><button type="submit" class="btn btn-success">Submit</button></a>
...
function myFunction() {
	...
	cell2.innerHTML = "<input type='text' name='City' class='form-control' placeholder='Enter City...' />";
	cell3.innerHTML = "<input type='text' name='State' class='form-control' placeholder='Enter State...' />";
	cell4.innerHTML = "<input type='text' name='Pin_code' class='form-control' placeholder='Enter Pin code....' />";
