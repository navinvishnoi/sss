...
.Manually_Rate{display:none;}
	...
	$Production_Owner = '';
	 ...
	 ?>
                ...
                <div class="box box-success">
                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="<?php echo base_url()."user/Sales_order_list"; ?>"><input type="button" class="btn btn-success" value="Submit" /></a>
        ...
        <script src="j<?php echo asset_url(); ?>s/AdminLTE/demo.js" type="text/javascript"></script>
        <!-- InputMask -->
