                ...
                <section class="content-header">
                    <h1><?php echo $Edit; ?> Invoice</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()."user/Invoice_list"; ?>"><i class="fa fa-star"></i>Invoice List</a></li>
                 ...
                 <div class="col-md-12">
                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="<?php echo base_url()."user/Invoice_list"; ?>"><input type="button" class="btn btn-success" value="Submit" /></a>
...
function myFunction() {
	...
	cell7.innerHTML = "<a href='<?php echo base_url()."user/View_Inventory"; ?>'><button type='button' class='btn btn-success' data-toggle='tooltip' title='View Item Detail'><i class='fa  fa-eye'></i></button></a> <button type='button' class='btn btn-danger' onclick='deleteRow(this);' data-toggle='tooltip' title='Delete Item'><i class='fa  fa-times'></i></button>";
