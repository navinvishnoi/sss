...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | Lead Genration List</title>
    ...
    <?php include("include/sidebar.php"); ?>
            ...
            <aside class="right-side">                
                ...
                <a href="<?php echo base_url()."user/Add_Lead_Genration"; ?>"><button type="button" class="btn btn-default" data-toggle="tooltip" title="Add New"><i class='fa fa-plus'></i></button></a>
                ...
                <table id="dataTables-example" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                        <?php foreach($Lead_genration_list as $value){ ?>
                                            <tr class="gradeA">
                                            
                                                <td><div class="checkbox"><input type="checkbox"></div></td>
                                                <td><?php echo $value->ID; ?></td>
                                                <td><?php echo $value->Lead; ?></td>
                                                <td><?php echo $value->Lead_Short_Name; ?></td>
                                                <td><?php echo $value->Lead_Next_Follow_up_Date; ?></td>
                                                <td><?php echo $value->Lead_Contact_Person; ?></td>
                                                <td><?php echo $value->Lead_Contact_Number; ?></td>
                                                <td><?php echo $value->Lead_Email_ID; ?></td>
                                                <td><?php echo $value->Lead_Status; ?></td>
                                                <td><a href="<?php echo base_url()."User/View_Lead_Genration/".$value->ID; ?>"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                    <a href="<?php echo base_url()."User/Edit_Lead_Genration/".$value->ID; ?>"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" title="Edit"><i class='fa fa-edit'></i></button></a>
