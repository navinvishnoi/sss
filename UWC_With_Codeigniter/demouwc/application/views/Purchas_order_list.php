...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | Purchase Order List</title>
    ...
    <?php include("include/sidebar.php"); ?>
            ...
            <aside class="right-side">                
                ...
                <a href="<?php echo base_url()."user/Add_Purchase_Order"; ?>"><button type="button" class="btn btn-default" data-toggle="tooltip" title="Add New"><i class='fa fa-plus'></i></button></a>
                ...
                <table id="dataTables-example" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            <tr class="gradeA">
                                                ...
                                                <td>SSISM</td>
                                                <td>Draft</td>
                                                <td><a href="<?php echo base_url()."user/View_Purchase_Order"; ?>"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                    <a href="<?php echo base_url()."user/Add_Purchase_Order"; ?>?edit"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" title="Edit"><i class='fa fa-edit'></i></button></a>
