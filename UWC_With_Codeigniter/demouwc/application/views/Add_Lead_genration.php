...
<html>
	...
	$Lead_Address = "ABCDEFGHIJKLMNOPQRSTU";
	$City = "Khategaon";
	$State = "MP";
	$Pin_code = "455336";
	...
	$Lead_Status = "Open";
	$Lead_Class = "School";
	$Lead_Area_Manager = "Area_Manager_1";
	$Call_By = "Rahul";
	...
	$Reference_Contact_Number = '';
	 ...
	 ?>
            ...
            <aside class="right-side">
                ...
                <form method="post" name="Form" action="<?php echo base_url()."user/Add_Lead_genration"; ?>"  id="Add_Lead" enctype="multipart/form-data" >
                <div class="col-lg-12">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_ID"   class="form-control" name="Lead_ID" placeholder="Enter Lead ID..." value="<?php echo $Lead_ID; ?>" />
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Lead* <span id="Lead_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead"   class="form-control" name="Lead" placeholder="Enter Lead..." value="<?php echo $Lead_ID; ?>" />
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Short Name* <span id="Lead_Short_Name_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Short_Name"   class="form-control" name="Lead_Short_Name" placeholder="Enter Sort Name..." value="<?php echo $Lead_Short_Name; ?>" />
                                        </div><!-- /.input group -->
                                        </div>
                                         <div class="col-xs-6">
                                       <!-- select -->
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="Lead_Type" autofocus="off" id="Lead_Type">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="Lead_Class" autofocus="off" id="Lead_Class">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="Lead_Area_Manager" autofocus="off" id="Lead_Area_Manager">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_City"   name="Lead_City" class="form-control" value="<?php echo $City; ?>" placeholder="Enter City..." />
                                        </div>
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">State/Province* <span id="Lead_State_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_State"   name="Lead_State" class="form-control" value="<?php echo $State; ?>" placeholder="Enter State..." />
                                        </div>
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Zip/Pin Code* <span id="Lead_Pin_Code_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Pin_Code"   name="Lead_Pin_Code" class="form-control" value="<?php echo $Pin_code; ?>" placeholder="Enter Pin code..." />
                                        </div>
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_Landline_Number"   class="form-control" name="Lead_Landline_Number" placeholder="Enter Number..." value="<?php echo $Landline_Number; ?>"/>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Contact Person* <span id="Lead_Contact_Person_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Contact_Person"   class="form-control" name="Lead_Contact_Person" placeholder="Enter Name..." value="<?php echo $contactperson; ?>"/>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Degingnation* <span id="Lead_Degingnation_error"  style="color:#F56780"></span></label>
                                            <textarea class="form-control" autofocus="off" id="Lead_Degingnation" name="Lead_Degingnation" rows="1" placeholder="Enter Degingnation..."><?php echo $Degingnation; ?></textarea>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Contact Number* <span id="Lead_Contact_Number_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Contact_Number"   class="form-control" name="Lead_Contact_Number" placeholder="Enter Number..." value="<?php echo $contactno; ?>"/>
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Email ID* <span id="Lead_Email_ID_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Email_ID"   class="form-control" name="Lead_Email_ID" placeholder="Enter Email ID..." value="<?php echo $email; ?>"/>
                                        </div><!-- /.input group -->
                                        </div>
                                         <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Business Email ID* <span id="Lead_Business_Email_ID_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Business_Email_ID"   class="form-control" name="Lead_Business_Email_ID" placeholder="Enter Business Email ID..." value="<?php echo $Business_Email_ID; ?>"/>
                                        </div><!-- /.input group -->
                                        </div>
                                         <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Called By* <span id="Lead_Called_by_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Called_by"   class="form-control" name="Lead_Called_by" value="<?php echo $Call_By; ?>" placeholder="Enter Name..." />
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_Called_on"   class="form-control" name="Lead_Called_on" value="<?php echo $Call_Date; ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_Visited_by"   class="form-control" name="Lead_Visited_by" value="<?php echo $Visit_By; ?>" placeholder="Enter Name..." />
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_Visited_on"   class="form-control" name="Lead_Visited_on" value="<?php echo $Visit_Date; ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                        </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                        </div>
                                        <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" autofocus="off" id="Lead_Response" name="Lead_Response" rows="1" placeholder="Enter Response..."><?php echo $Response; ?></textarea>
                                        </div>
                                        </div>
                                        <div class="col-xs-6">
                                        <!-- textarea -->
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" autofocus="off" id="Lead_Next_Follow_up" name="Lead_Next_Follow_up" rows="1" placeholder="Enter Fellow-up..."><?php echo $Further_Follow_up; ?></textarea>
                                        </div>
                                        </div>
                                        <div class="col-md-6">
                                        <!-- Date dd/mm/yyyy -->
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" autocomplete="off" id="Lead_Next_Follow_up_Date" class="form-control" name="Lead_Next_Follow_up_Date" value="<?php echo $Follow_up_Date; ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                        </div>
                                        <div class="col-xs-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control" name="Lead_Status" autofocus="Lead_Status" id="Lead_Status">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" autocomplete="off"  id="Lead_Reference_Name"   class="form-control" name="Lead_Reference_Name"  value="<?php echo $Reference_Name; ?>"  placeholder="Enter Name..." />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            <label for="inputName">Contact Number* <span id="Lead_Reference_Contact_Number_error"  style="color:#F56780"></span></label>
                                            <input type="text" autocomplete="off"  id="Lead_Reference_Contact_Number"   class="form-control" name="Lead_Reference_Contact_Number" value="<?php echo $Reference_Contact_Number; ?>" placeholder="Enter Number..." />
                                        </div><!-- /.input group -->
                                    </div><!-- /.form group -->
                                    </div>
                                </div><!-- /.box-body -->
