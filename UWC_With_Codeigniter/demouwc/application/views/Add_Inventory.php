...
<html>
                ...
                <section class="content-header">
                    <h1><?php echo $Edit; ?> Item</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="<?php echo base_url()."user/Inventory_list"; ?>"><i class="fa fa-star"></i>Inventory List</a></li>
                                      ...
                                      <br> <table id="myTable" class="table table-bordered table-striped ">
                                        <thead>
                                          ...
                                          <tr>
                                            ...
                                            <td><input type="text" class="form-control" placeholder="Enter Delivery Time..."></td>
                        ...
                        <div class="box box-success">
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            <label>Size</label>
                                            <input type="text" class="form-control"  value="<?php echo $Size; ?>" placeholder="Enter Size..." />
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control"  value="<?php echo $Minimum_Point; ?>" placeholder="Enter Maximum Point..." />
                                        </div><!-- /.input group -->
                                        </div>
                                    </div>
                                </div>
	...
	cell4.innerHTML = "<input type='text' name='Brand[]' class='form-control' placeholder='Enter Brand...' />";
	cell5.innerHTML = "<input type='text' name='Delivery_Time[]' class='form-control' placeholder='Enter Delivery Time...' />";
	cell6.innerHTML = "<button type='button' class='btn btn-danger' onclick='deleteRow(this);' data-toggle='tooltip' title='Delete'><i class='fa  fa-times'></i></button>  ";
...
function myFunction1() {
	...
	cell2.innerHTML = "<input type='text' name='Vendor_Product_Code' class='form-control' placeholder='Enter Vendor Product Code...' />";
	...
	cell6.innerHTML = "<input type='text' name='Company' class='form-control' placeholder='Enter Company...' />";
	cell7.innerHTML = "<input type='text' name='Delivery_Time[]' class='form-control' placeholder='Enter Delivery Time...' />";
...
function myFunction2() {
	...
	cell6.innerHTML = "<button type='button' class='btn btn-danger' onclick='deleteRow2(this);' data-toggle='tooltip' title='Delete'><i class='fa  fa-times'></i></button>";
}
...
function myFunction3() {
	...
	cell8.innerHTML = "<input type='text' name='Delivery_Time[]' class='form-control' placeholder='Enter Delivery Time...' />";
	cell9.innerHTML = "<button type='button' class='btn btn-danger' onclick='deleteRow3(this);' data-toggle='tooltip' title='Delete'><i class='fa  fa-times'></i></button>";
}
