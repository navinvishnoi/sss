...
<style>p{color:red;} </style>
	<div class="row">
  	<form method="post"  action="<?php echo base_url()."welcome/uploadImage"; ?>" name="uploadlogo" id="uploadlogo"  enctype="multipart/form-data" >
 <div class="form-group">
           
              <div class="controls" >
              <div class="fileUpload btn" style="margin-left:0px;">  
                <span class="text-center"><?php echo $this->lang->line("Upload_logo"); ?></span>
                <input type="file" class="upload" name="logo" id="logo" onChange="submitfrom()" ></div>
...
function submitfrom()
{
	document.getElementById("uploadlogo").submit();
	}
