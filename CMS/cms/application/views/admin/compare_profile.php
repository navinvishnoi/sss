...
foreach($getmemberbyid as $value) {
	...
	$status=$value->Member_Current_Status;
	 ...
	 if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") {  ?>
...
if(isset($getmemberbyid)) { foreach($getmemberbyid as $value) { 
 ...
 ?>
	...
	<!--<div class="component component-headline col-md-12 col-lg-12">
		<div class="col-xs-8 col-lg-10">-->
			
			<h1 style="margin-left: -15px;"><?php echo $value->Member_Name; ?></h1>
	...
	<div class="row" >
		<div class="panel-body" style="margin-left:-40px;">
             ...
             <form method="post"> <table class="table">
              <tr>
              <th></th>
              <th><h2 style="margin-left:17px;">Aktuelles <br> Profil</h2></th>
              </tr>
              <tr>
             ...
             <div class="controls col-md-12 col-lg-12" >
              ...
              value='<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") 
			  {
				   echo str_replace("'","&lsquo;",$value->Member_Name); } ?>' >
              </div>
              </td>
              </tr>
               <tr>
             ...
             <select name="Member_Type" id="BMember_Type" class="form-control" readonly>
			  ...
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") { echo "<option>".$value->Member_Type."</option>";}
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_Address_Street); ?>' >
              </div>
              </td>
               </tr>
              ...
              value="<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_ZIP; ?>"  maxlength="5">
              </div>
              </td>
              </tr>
              <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_City); ?>' >
              </div></td>
              </tr>
               <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_Clubheim); ?>' >
              </div></td>
              </tr>
              <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_President); ?>' >
              </div></td>
              </tr>
               <tr>
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <a href="<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_Website; ?>" 
              style="text-decoration:underline;background-color:#eee;"  class="form-control" target="_blank">
			  <?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_Website; ?></a>
              ...
              value="<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_House_No; ?>" >
              </div>
              </td>
               </tr>
              <tr>
              ...
              value="<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_Telephone; ?>" >
              </div>
              </td>
              </tr>
              ...
              <td> <label class="control-label" for="inputName">Facebook </label></td>
               ...
               <td>
               <div class="controls col-md-12 col-lg-12" ><a href="<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_FB_Address; ?>" style="background-color:#eee;text-decoration:underline;" class="form-control"><?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->Member_FB_Address; ?></a>
               ...
               <div class="controls col-md-12 col-lg-12" ><a href='<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_Twtr_Address); ?>' style="background-color:#eee;text-decoration:underline;" class="form-control">
			   <?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_Twtr_Address); ?></a>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_Country); ?>' >
              </div></td>
              </tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_name); ?>' >
              </div>
              </td>
              </tr>
               <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_first_name); ?>' >
              </div>
              </td>
              </tr>
             <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_position); ?>' >
              </div>
              </td>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_street_no); ?>' >
              </div>
              </td>
              </tr>
              <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_house_no); ?>' >
              </div>
              </td>
              </tr>
              <tr>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_zip); ?>' >
              </div>
              </td>
              </tr>
               <tr>
              <td> <label class="control-label" for="inputName">Ort</label></td>
              ...
              value='<?php  if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_city); ?>' >
              </div>
              </td>
              </tr>
              ...
              value='<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->MA_phone); ?>' >
              </div>
              </td>
              </tr>
              <tr>
              ...
              value="<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->MA_mobile; ?>" >
              </div>
              </td>
              </tr>
              <tr>
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" ><a href="mailto:<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $MemberCurrentMail=$value->MA_email; ?>" style="background-color:#eee;text-decoration:underline;" class="form-control"><?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo $value->MA_email; ?></a>
            <input type="hidden"  id="BMA_email" class="form-control" readonly name="BMA_email" value='<?php echo $value->MA_email; ?>' >
               ...
               value='<?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") echo str_replace("'","&lsquo;",$value->Member_Multiple_Sports); ?>' >
               </div>
               </td>
               </tr>
               <tr>
			   ...
			   <div class="desc"> <?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") { $descvalue1=$value->Member_Desc;}
			    echo wordwrap(html_entity_decode(str_replace("<br />","",$descvalue1)),60,"\n",true); ?></div></div> </td>
               </tr>
               <tr>
               ...
               <img  src="<?php $imgname=''; if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion")
			    {$width='';$height='';
              ...
              <table class="table">
              <tr>
              <th><h2 style="margin-left:14px;">Geändertes <br> Profil</h2></th>
              <th style="  max-width: 60px;"><h2 >Überarbeitung angefordert</h2></th>
              </tr>
              <tr>
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text"  id="Member_Name" class="form-control" name="Member_Name" value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_Name); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_Address_Street); ?>' >
             ...
             <tr>
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
		      <input type="text"  id="Member_ZIP" class="form-control" maxlength="10" name="Member_ZIP" value="<?php //if($status=="Modify" || $status=="New") 
			  echo $data->Member_ZIP; ?>" >
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text"  id="Member_City" class="form-control" name="Member_City" value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_City); ?>' >
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text"  id="Member_Clubheim" class="form-control" name="Member_Clubheim" value='<?php //if($status=="Modify" || $status=="New")
			   echo str_replace("'","&lsquo;",$data->Member_Clubheim); ?>' >
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text"  id="Member_President" class="form-control" name="Member_President" value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_President); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_Website); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_House_No); ?>' >
              </div>
			  ...
			  echo $data->Member_Telephone; ?>" >
               ...
               <td>
               <div class="controls col-md-12 col-lg-12" >
               <input type="text"  id="Member_FB_Address" class="form-control" name="Member_FB_Address" value='<?php //if($status=="Modify" || $status=="New") 
			   echo str_replace("'","&lsquo;",$data->Member_FB_Address); ?>' >
               </div>
               ...
               value='<?php //if($status=="Modify" || $status=="New") 
			   echo str_replace("'","&lsquo;",$data->Member_Twtr_Address); ?>' >
               </div>
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->Member_Country); ?>' >
              </div>
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text"  id="MA_name" class="form-control" name="MA_name" 
              value='<?php echo str_replace("'","&lsquo;",$data->MA_name); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_first_name); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_position); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_street_no); ?>' >
              </div>
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_house_no); ?>' >
              </div>
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_zip); ?>' >
              ...
              value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_city); ?>' >
              </div>
             ...
             <!-- <tr>
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text"  id="MA_phone" class="form-control" name="MA_phone" value="<?php //if($status=="Modify" || $status=="New") 
			  echo $data->MA_phone; ?>" >
              ...
              <td>
              <div class="controls col-md-12 col-lg-12" >
              <input type="text" id="MA_email" class="form-control" role="link" name="MA_email" value='<?php //if($status=="Modify" || $status=="New") 
			  echo str_replace("'","&lsquo;",$data->MA_email); ?>' >
              <div id="MA_email_error"  style="color:#F56780"></div>
               ...
               value='<?php //if($status=="Modify" || $status=="New") 
			   echo str_replace("'","&lsquo;",$data->Member_Multiple_Sports); ?>' >
               </div>
               </td><td>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="checkbox" name="Member_Multiple_Sports_isReject" id="Member_Multiple_Sports_isReject"></td>
               </tr>
               <tr>
               <td> 
               <div class="controls col-md-12 col-lg-12 " id="Member_Desc_div" >
			  ...
			  $strresult=strcmp($descvalue,$data->Member_Desc);  
               ...
               <textarea  cols="35" rows="10" class="form-control ckeditor" id="Member_Desc" name="Member_Desc" maxlength="500" 
               style="resize:none;overflow:hidden;<?php echo $showbold; ?>"><?php echo wordwrap(str_replace("<br />","",$data->Member_Desc),30,"\n",true); ?></textarea>
			  ...
			  $width='';$height='';
				/*if($status=="Modify" || $status=="New")
				{*/
				 if($data->Member_logo==="0") { $imgname1="No_Logo.png";$width=90;$height=90;}
					elseif($data->Member_logo!="") 
					{
						$imgname1=$data->Member_logo;
							if(file_exists("./assets/img/Uploadlogos/".$imgname1))
								{
									/* Get the image info */
								$info = getimagesize(asset_url()."img/Uploadlogos/".$imgname1);
								...
								/* Use the 'newHeight' in the CSS height property below. */
								$width .= "px";
							}else{$imgname1="No_Logo.png";$width=90;$height=90;}
						}
					else{$imgname1="No_Logo.png";$width=90;$height=90;}
				//}else{$imgname1="No_Logo.png";$width=90;$height=90;}
			  ?>
              <div  style="width:100px;height:100px;margin-top:10px;margin-left:13px;" class="text-center 
			   <?php if($value->Member_Current_Status!="New" 
			  && $value->Member_Current_Status!="New_Rejected" 
			  && $value->Member_Current_Status!="New_Request_For_Deletion") { if($imgname!=$imgname1){ echo "reject_border";} }?> ">
              <div id="showbox"> 
              <img src="<?php  echo asset_url()."img/Uploadlogos/".$imgname1; ?>" width="<?php echo $width; ?>" height="<?php echo $height; ?>">
            ...
            <?php if($status!="Request_For_Deletion" && $status!="New_Request_For_Deletion") {?> 
                 <button type="submit" title="<?php echo $this->lang->line("Accept"); ?>" 
                   ...
                   <img src="<?php echo asset_url(); ?>img/orange_icons/accept_24.png"></button>
                     <a onClick="reject()" title="<?php echo $this->lang->line("Reject_btn"); ?>">
                 <img src="<?php echo asset_url(); ?>img/orange_icons/reject_24.png" class="btn13" ></a>
                  <?php } else { ?> 
                  <a id="showmodel1" onclick="return validateForm()" title="<?php echo $this->lang->line("Accept"); ?>" > <img class="btn13" src="<?php echo asset_url(); ?>img/orange_icons/accept_24.png"></a>
				     <a id="showmodel2" title="<?php echo $this->lang->line("Reject_btn"); ?>">
               ...
               <a id="showmodel">
               <img src="<?php echo asset_url(); ?>img/orange_icons/reject.png" class="btn13" title="<?php echo $this->lang->line("delete_btn_rfd"); ?>"></a>
               </div>
                  <br> <br>  <a href="<?php echo base_url()."admin/?sessionid=".$sessionid; ?>" style="margin-left:10px;" >zurück zur Liste«</a> </div>      
             </div>
             <!--COMPOSE MESSAGE MODAL  -->
 <div class="modal fade" id="Accept_reject_modal" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title" id="model-title"> <?php echo $this->lang->line("Accept"); ?></h4>
      </div>
      <div class="modal-body">
        <p> <?php echo $this->lang->line("Accept_After_deletion_confirm_msg"); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line("cancel"); ?></button>
        <button type="submit" id="Accept" title="<?php echo $this->lang->line("Accept"); ?>" 
                   class="btn btn-default" onclick="return validateForm()" name="Accept" style="display:none;">
                   <?php echo $this->lang->line("Accept"); ?></button>
        <a onClick="reject()" id="Reject"  class="btn btn-default" style="display:none;"><?php echo $this->lang->line("delete"); ?></a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->  
 ...
 <div class="modal fade" id="delete-modal" tabindex="-1" role="dialog" aria-hidden="true">
   <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-header">
        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
        <h4 class="modal-title"><?php echo $this->lang->line("delete_btn_rfd"); ?></h4>
      </div>
      <div class="modal-body">
        <p><?php echo $this->lang->line("Delete_notification_text"); ?></p>
      </div>
      <div class="modal-footer">
        <button type="button" class="btn btn-default" data-dismiss="modal"><?php echo $this->lang->line("cancel"); ?></button>
        <a href="<?php echo base_url().'admin/delete/'.$data->Member_App_Id."/".$sessionid; ?>"  class="btn btn-default">
		<?php echo $this->lang->line("delete_btn_rfd"); ?></a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal --> 
...
$('#Accept').hide();
$('#Reject').show();
document.getElementById('model-title').innerHTML =  "<?php echo $this->lang->line("Reject"); ?>";
});
...
{
var Member_Desc = CKEDITOR.instances.Member_Desc.getData();
...
if( (Member_Name==0) ||(Member_Type==0) ||  (Member_Dist=="") || (Member_ZIP==0) ||(MA_name==0)||
(MA_first_name==0)||(MA_position==0) ||(MA_email==0)||(Member_Desc==0) ||(Member_City==0) || (Member_Address_Street==0) || (Member_President==0))
{
	 if(Member_Name==0)
	 {
...
$('#Accept').show();
$('#Reject').hide();
document.getElementById('model-title').innerHTML =  "<?php echo $this->lang->line("Accept"); ?>";
<?php } ?>
console.log("hello////////");
return true;
}	
...
{
	document.getElementById("Member_Name").className = "form-control reject_border";
}	
if(document.getElementById("BMember_Address_Street").value!=document.getElementById("Member_Address_Street").value)
{
	document.getElementById("Member_Address_Street").className = "form-control reject_border";
}
if(document.getElementById("BMember_House_No").value!=document.getElementById("Member_House_No").value)
{
	document.getElementById("Member_House_No").className = "form-control reject_border";
}
if(document.getElementById("BMember_ZIP").value!=document.getElementById("Member_ZIP").value)
{
	document.getElementById("Member_ZIP").className = "form-control reject_border";
}
if(document.getElementById("BMember_City").value!=document.getElementById("Member_City").value)
{
	document.getElementById("Member_City").className = "form-control reject_border";
}
if(document.getElementById("BMA_position").value!=document.getElementById("MA_position").value)
{
	document.getElementById("MA_position").className = "form-control reject_border";
}
if(document.getElementById("BMember_Country").value!=document.getElementById("Member_Country").value)
{
	document.getElementById("Member_Country").className = "form-control reject_border";
}
if(document.getElementById("BMember_Dist").value!=document.getElementById("Member_Dist").value)
{
	document.getElementById("Member_Dist").className = "form-control reject_border";
}
if(document.getElementById("BMember_FB_Address").value!=document.getElementById("Member_FB_Address").value)
{
	document.getElementById("Member_FB_Address").className = "form-control reject_border";
}
if(document.getElementById("BMember_Twtr_Address").value!=document.getElementById("Member_Twtr_Address").value)
{
	document.getElementById("Member_Twtr_Address").className = "form-control reject_border";
}
if(document.getElementById("BMember_Type").value!=document.getElementById("Member_Type").value)
{
	document.getElementById("Member_Type").className = "form-control reject_border";
}
if(document.getElementById("BMember_Multiple_Sports").value!=document.getElementById("Member_Multiple_Sports").value)
{
	document.getElementById("Member_Multiple_Sports").className = "form-control reject_border";
}
if(document.getElementById("BMember_Website").value!=document.getElementById("Member_Website").value)
{
	document.getElementById("Member_Website").className = "form-control reject_border";
}
if(document.getElementById("BMA_city").value!=document.getElementById("MA_city").value)
{
	document.getElementById("MA_city").className = "form-control reject_border";
}
if(document.getElementById("BMember_Telephone").value!=document.getElementById("Member_Telephone").value)
{
	document.getElementById("Member_Telephone").className = "form-control reject_border";
}
if(document.getElementById("BMA_email").value!=document.getElementById("MA_email").value)
{
	document.getElementById("MA_email").className = "form-control reject_border";
}
if(document.getElementById("BMA_first_name").value!=document.getElementById("MA_first_name").value)
{
	document.getElementById("MA_first_name").className = "form-control reject_border";
}
if(document.getElementById("BMA_house_no").value!=document.getElementById("MA_house_no").value)
{
	document.getElementById("MA_house_no").className = "form-control reject_border";
}
if(document.getElementById("BMA_mobile").value!=document.getElementById("MA_mobile").value)
{
	document.getElementById("MA_mobile").className = "form-control reject_border";
}
if(document.getElementById("BMA_name").value!=document.getElementById("MA_name").value)
{
	document.getElementById("MA_name").className = "form-control reject_border";
}
if(document.getElementById("BMA_phone").value!=document.getElementById("MA_phone").value)
{
	document.getElementById("MA_phone").className = "form-control reject_border";
}
if(document.getElementById("BMA_position").value!=document.getElementById("MA_position").value)
{
	document.getElementById("MA_position").className = "form-control reject_border";
...
{
	document.getElementById("MA_street_no").className = "form-control reject_border";
}
if(document.getElementById("BMA_zip").value!=document.getElementById("MA_zip").value)
{
	document.getElementById("MA_zip").className = "form-control reject_border";
}
if(document.getElementById("BMember_Clubheim").value!=document.getElementById("Member_Clubheim").value)
{
	document.getElementById("Member_Clubheim").className = "form-control reject_border";
}
if(document.getElementById("BMember_President").value!=document.getElementById("Member_President").value)
{
	document.getElementById("Member_President").className = "form-control reject_border";
}	
}
</script>
