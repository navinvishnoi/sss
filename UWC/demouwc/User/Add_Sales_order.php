...
.Manually_Rate{display:none;}
	...
	$Production_Owner = "Rohit Sisodiya";
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="Navin Vishnoi" placeholder="Enter Order ID..." >
                                        </div><!-- /.input group -->
                                        </div>
                                    <div class="col-xs-6">
                                        <div class="form-group">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $Production_Owner; ?>" placeholder="Enter Name..." />
                                        </div><!-- /.input group -->
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
