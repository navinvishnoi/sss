                ...
                <section class="content-header">
                    <h1>Receipt Entry</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="Receipt_Entry.php"><i class="fa fa-star"></i>Receipt Entry</a></li>
                    ...
                    <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Receipt Number..." value="" readonly/>
                                        </div><!-- /.input group -->
                                        </div>
                                        </div>                                 
                                </div>
                    ...
                    <div class="box-body">
                                    <div class="row">
                                       ...
                                       <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" placeholder="Enter Recieved Amount..." value="" />
                                        </div>
                                        </div>
                                        </div>
                                        </div>                                 
