...
<html>
    ...
    <?php include("include/sidebar.php"); ?>
           ...
           <a href="Add_Vendor.php"><button type="button" class="btn btn-default" data-toggle="tooltip" title="Add New"><i class='fa fa-plus'></i></button></a>
                                        ...
                                        <tbody>
                                            <tr class="gradeA">
                                                ...
                                                <td><a href="View_Vendor.php"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                    <a href="Add_Vendor.php?edit"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" title="Edit"><i class='fa fa-edit'></i></button></a>
