...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | Add New Quotation</title>
	 ...
	 ?>
            ...
            <aside class="right-side">
                ...
                <section class="content-header">
                    <h1><?php echo $Edit; ?> Quotation</h1>
                     <ol class="breadcrumb">
                        <li><a href="home.php"><i class="fa fa-dashboard"></i> Home</a></li>
                        <li><a href="Quotation_list.php"><i class="fa fa-star"></i>Quotation List</a></li>
                                ...
                                <div class="box-body">
                                    <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" value="<?php echo $Quotation_ID; ?>" placeholder="Enter Quoted ID..." />
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-md-6">
                                        <!-- Date dd/mm/yyyy -->
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" value="<?php echo $Quotation_Date; ?>" data-inputmask="'alias': 'dd/mm/yyyy'" data-mask/>
                                            </div><!-- /.input group -->
                                        </div><!-- /.form group -->
                                        </div>
                                        <div class="col-xs-6">
                                        <div class="form-group">
		                                    ...
		                                    <option value="Draft" <?php if($Quotation_Status=='Draft') echo "selected"; ?>>Draft</option>
                                            <option value="Sent" <?php if($Quotation_Status=='Sent') echo "selected"; ?>>Sent</option>
                                            </select>
                                        </div><!-- /.input group -->
                                        </div>
                ...
                <div class="col-md-12">
                           ...
                           <div class="box box-success">
                               <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                            <label>Remarks</label>
                                            <textarea class="form-control" rows="4" placeholder="Enter Remarks..."></textarea>
                                        </div>
                                        </div>
                                    </div>
                                </div><!-- /.box-body -->
                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="Quotation_list.php"><input type="button" class="btn btn-success" value="Submit" /></a>
...
function myFunction() {
	...
	cell8.innerHTML = "<a href='View_Inventory.php'><button type='button' class='btn btn-success' data-toggle='tooltip' title='View Item Detail'><i class='fa  fa-eye'></i></button></a> <button type='button' class='btn btn-danger' onclick='deleteRow(this);' data-toggle='tooltip' title='Delete'><i class='fa  fa-times'></i></button>";
