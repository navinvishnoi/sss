                 ...
                 <div class="box box-success">
                           ...
                           <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                       <!-- select -->
                                        <div class="form-group">
                                         <a href="Add_Quotation.php?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Generate Quotation"><i class="fa fa-plus"></i>&nbsp; Generate Quotation</button></a>
