                ...
                <table id="dataTables-example" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            <tr class="gradeA">
                                                ...
                                                <td>Pranjal Dubey</td>
                                                <td>9898989898</td>
                                                <td>Pranjal@ssism.org</td>
                                                <td><a href="View_Product.php"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                </td>
                                            </tr>
                                        </tbody>
                                    </table>
