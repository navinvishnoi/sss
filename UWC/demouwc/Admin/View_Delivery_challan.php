...
<html>
    <head>
        <meta charset="UTF-8">
        <title>UWC | View Delivery Challan</title>
                ...
                <section class="content-header">
                    <h1>&nbsp;View Delivery Challan</h1>
                     <ol class="breadcrumb">
                        ...
                        <li><a href="Delivery_challan_list.php"><i class="fa fa-star"></i>Delivery Challan List</a></li>
                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                        <div class="form-group">
                                          <label class="col-xs-6">Delivery Challan ID</label>
                                          DCN243
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-md-12">
                                        <!-- Date dd/mm/yyyy -->
                                        <div class="form-group">
                                            <label class="col-xs-6">Delivery Challan Date</label>
                                            23/12/2015
                                        </div><!-- /.form group -->
                                        </div>
                                        <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="col-xs-6">Deliver To</label>
                                            SSISM
                                        </div><!-- /.input group -->
                                        </div>
                                         <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="col-xs-6">Attender</label>
                                            SSISM
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-12">
                                        ...
                                        <div class="col-xs-12">
                                        <div class="form-group">
                                            <label class="col-xs-6">City/State</label>
                                            ABCDEFGHI
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-12">
                ...
                <div class="box box-success">
                 ...
                 <div class="col-md-12">
                        ...
                        <table id="dataTables-example" class="table table-bordered table-striped ">
                           ...
                           <div class="box box-success">
                                <div class="box-header">
                                    <h3 class="box-title"><i class="fa fa-check"></i>&nbsp;Authorised by: <strong>Manager 1</strong>
                                </div>
                                <!-- /.box-body -->
                           </div>
                           <div class="box box-success">
