                ...
                <div class="box box-success">
                           ...
                           <div class="col-md-12">
                             ...
                             <div class="box box-primary">
                              ...
                              <tr>
                                ...
                                <td><input type="text" class="form-control" value="10" placeholder="Enter Sent Qty...." /></td>
                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    <div class="row">
                                    <div class="col-xs-12">
                                       <a href="Delivery_challan_list.php"><input type="button" class="btn btn-success" value="Submit" /></a>
