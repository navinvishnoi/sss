                                ...
                                <div class="box-body">
                                    <div class="row">
                                       ...
                                       <div class="col-xs-6">
                                        ...
                                        <div class="col-xs-6">
                                        <div class="form-group">
                                        <label class="col-xs-4" >Card Security Code</label>
                                         12345
                                        </div><!-- /.input group -->
                                        </div>
                                        <div class="col-xs-6">
                            ...
                            <div class="box box-success">
                             ...
                             <div class="box box-primary">
                                <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class=" table-responsive">
                                        <table id="dataTables-example2" border="0" class="table table-bordered table-striped ">
                              <thead>
                              <tr>
                            ...
                            <div class="box box-success">
                             ...
                             <div class="box box-primary">
                                <div class="box-body">
                                    ...
                                    <div class="col-md-12">
                                        <div class=" table-responsive">
                                        <table id="dataTables-example3" border="0" class="table table-bordered table-striped ">
                             <thead>
                              <tr>
                                <th scope="col">Sr. No.</th>
                                <th scope="col">Address</th>
