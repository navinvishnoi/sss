                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                       <!-- select -->
                                        <div class="form-group">
                                         <a data-toggle="modal" data-target="#compose-modal"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Send Customer"><i class="fa fa-envelope"></i>&nbsp; Send Customer</button></a>
                                         <a href="Add_Sales_order.php?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Generate Sales Order"><i class="fa fa-plus"></i>&nbsp; Generate Sales Order</button></a>
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="#" method="post">
                        ...
                        <div class="modal-footer clearfix">
                        <a href="View_Quotation.php"><button type="button" class="btn btn-primary pull-left" data-dismiss="modal" data-toggle="tooltip" title="View Last Quotation Version"><i class="fa fa-eye"></i> View Last Quotation Version</button></a>
