...
<html>
    ...
    <?php include("include/sidebar.php"); ?>
            ...
            <aside class="right-side">                
                ...
                <a href="Add_Lead_Genration.php"><button type="button" class="btn btn-default" data-toggle="tooltip" title="Add New"><i class='fa fa-plus'></i></button></a>
                ...
                <table id="dataTables-example" class="table table-bordered table-striped ">
                                        ...
                                        <tbody>
                                            <tr class="gradeA">
                                                ...
                                                <td><div class="checkbox"><input type="checkbox"></td>
                                                <td>5</td>
                                                <td>SSISM</td>
                                                <td>SSISM01121</td>
                                                <td>23/12/1992</td>
                                                ...
                                                <td>Open</td>
                                                <td><a href="View_Lead_Genration.php"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                    <a href="Add_Lead_Genration.php?edit"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" title="Edit"><i class='fa fa-edit'></i></button></a>
