...
<html>
    ...
    <?php include("include/sidebar.php"); ?>
            ...
            <aside class="right-side">                
                ...
                <a href="Add_Item.php"><button type="button" class="btn btn-default" data-toggle="tooltip" title="New"><i class='fa fa-plus'></i></button></a>
                                         ...
                                         <tbody>
                                            <tr class="gradeA">
                                               ...
                                               <td>ITM2221</td>
                                                ...
                                                <td>25X25 50X50</td>
                                                <td>Navin Vishnoi</td>
                                                <td><a href="View_Item.php"><button type="button" class="btn btn-success btn-circle" data-toggle="tooltip" title="View"><i class='fa fa-eye'></i></button></a>
                                                    <a href="Add_Item.php?edit"><button type="button" class="btn btn-warning btn-circle" data-toggle="tooltip" title="Edit"><i class='fa fa-edit'></i></button></a>
