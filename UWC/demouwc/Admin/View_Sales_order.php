                           ...
                           <div class="box box-success">
                                <div class="box-body">
                                    ...
                                    <div class="col-xs-12">
                                       <!-- select -->
                                        <div class="form-group">
                                        <a href="Invoice_list.php?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Genrate Invoice"><i class="fa fa-plus"></i>&nbsp; Genrate Invoice</button></a>
                                        <a href="Delivery_challan_list.php?edit"><button type="button" class="btn btn-success" data-toggle="tooltip" title="Genrate Delivery challan"><i class="fa fa-plus"></i>&nbsp; Genrate Delivery challan</button></a>
